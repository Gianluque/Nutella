function varargout = Osciloscopio_12(varargin)
% OSCILOSCOPIO_12 MATLAB code for Osciloscopio_12.fig
%      OSCILOSCOPIO_12, by itself, creates a new OSCILOSCOPIO_12 or raises the existing
%      singleton*.
%
%      H = OSCILOSCOPIO_12 returns the handle to a new OSCILOSCOPIO_12 or the handle to
%      the existing singleton*.
%
%      OSCILOSCOPIO_12('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in OSCILOSCOPIO_12.M with the given input arguments.
%
%      OSCILOSCOPIO_12('Property','Value',...) creates a new OSCILOSCOPIO_12 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Osciloscopio_12_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Osciloscopio_12_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Osciloscopio_12

% Last Modified by GUIDE v2.5 05-Mar-2019 11:06:19

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Osciloscopio_12_OpeningFcn, ...
                   'gui_OutputFcn',  @Osciloscopio_12_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Osciloscopio_12 is made visible.
function Osciloscopio_12_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Osciloscopio_12 (see VARARGIN)

% Choose default command line output for Osciloscopio_12
...
z=1;
s=1;
% UIWAIT makes Osciloscopio_12 wait for user response (see UIRESUME)
% uiwait(handles.Osciloscopio);
end

% --- Outputs from this function are returned to the command line.
function varargout = Osciloscopio_12_OutputFcn(hObject, eventdata, handles) 
...
%canales Digitales    
    while get(handles.selectorCanal,'Value')==2
    %busqueda de inicio y adquisicion de bytes
         while a>127
            a=fread(puerto,1); 
         end
...
% handles    structure with handles and user data (see GUIDATA)
cla
set(handles.selectorCanal,'Value',3)
end
