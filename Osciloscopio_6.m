function varargout = Osciloscopio_6(varargin)
% OSCILOSCOPIO_6 MATLAB code for Osciloscopio_6.fig
%      OSCILOSCOPIO_6, by itself, creates a new OSCILOSCOPIO_6 or raises the existing
%      singleton*.
%
%      H = OSCILOSCOPIO_6 returns the handle to a new OSCILOSCOPIO_6 or the handle to
%      the existing singleton*.
%
%      OSCILOSCOPIO_6('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in OSCILOSCOPIO_6.M with the given input arguments.
%
%      OSCILOSCOPIO_6('Property','Value',...) creates a new OSCILOSCOPIO_6 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Osciloscopio_6_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Osciloscopio_6_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Osciloscopio_6

% Last Modified by GUIDE v2.5 05-Mar-2019 09:47:06

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Osciloscopio_6_OpeningFcn, ...
                   'gui_OutputFcn',  @Osciloscopio_6_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Osciloscopio_6 is made visible.
function Osciloscopio_6_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Osciloscopio_6 (see VARARGIN)

% Choose default command line output for Osciloscopio_6
...
z=0;
s=0;
% UIWAIT makes Osciloscopio_6 wait for user response (see UIRESUME)
% uiwait(handles.Osciloscopio);


% --- Outputs from this function are returned to the command line.
function varargout = Osciloscopio_6_OutputFcn(hObject, eventdata, handles) 
