function varargout = Osciloscopio_17(varargin)
% OSCILOSCOPIO_17 MATLAB code for Osciloscopio_17.fig
%      OSCILOSCOPIO_17, by itself, creates a new OSCILOSCOPIO_17 or raises the existing
%      singleton*.
%
%      H = OSCILOSCOPIO_17 returns the handle to a new OSCILOSCOPIO_17 or the handle to
%      the existing singleton*.
%
%      OSCILOSCOPIO_17('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in OSCILOSCOPIO_17.M with the given input arguments.
%
%      OSCILOSCOPIO_17('Property','Value',...) creates a new OSCILOSCOPIO_17 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Osciloscopio_17_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Osciloscopio_17_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Osciloscopio_17

% Last Modified by GUIDE v2.5 05-Mar-2019 18:53:54

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Osciloscopio_17_OpeningFcn, ...
                   'gui_OutputFcn',  @Osciloscopio_17_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Osciloscopio_17 is made visible.
function Osciloscopio_17_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Osciloscopio_17 (see VARARGIN)

% Choose default command line output for Osciloscopio_17
...
global d;
d=0;
% UIWAIT makes Osciloscopio_17 wait for user response (see UIRESUME)
% uiwait(handles.Osciloscopio);
end

% --- Outputs from this function are returned to the command line.
function varargout = Osciloscopio_17_OutputFcn(hObject, eventdata, handles) 
