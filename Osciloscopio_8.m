function varargout = Osciloscopio_8(varargin)
% OSCILOSCOPIO_8 MATLAB code for Osciloscopio_8.fig
%      OSCILOSCOPIO_8, by itself, creates a new OSCILOSCOPIO_8 or raises the existing
%      singleton*.
%
%      H = OSCILOSCOPIO_8 returns the handle to a new OSCILOSCOPIO_8 or the handle to
%      the existing singleton*.
%
%      OSCILOSCOPIO_8('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in OSCILOSCOPIO_8.M with the given input arguments.
%
%      OSCILOSCOPIO_8('Property','Value',...) creates a new OSCILOSCOPIO_8 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Osciloscopio_8_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Osciloscopio_8_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Osciloscopio_8

% Last Modified by GUIDE v2.5 05-Mar-2019 10:04:01

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Osciloscopio_8_OpeningFcn, ...
                   'gui_OutputFcn',  @Osciloscopio_8_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Osciloscopio_8 is made visible.
function Osciloscopio_8_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Osciloscopio_8 (see VARARGIN)

% Choose default command line output for Osciloscopio_8
...
z=0;
s=1;
% UIWAIT makes Osciloscopio_8 wait for user response (see UIRESUME)
% uiwait(handles.Osciloscopio);


% --- Outputs from this function are returned to the command line.
function varargout = Osciloscopio_8_OutputFcn(hObject, eventdata, handles) 
