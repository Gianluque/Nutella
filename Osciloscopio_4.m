function varargout = Osciloscopio_4(varargin)
% OSCILOSCOPIO_4 MATLAB code for Osciloscopio_4.fig
%      OSCILOSCOPIO_4, by itself, creates a new OSCILOSCOPIO_4 or raises the existing
%      singleton*.
%
%      H = OSCILOSCOPIO_4 returns the handle to a new OSCILOSCOPIO_4 or the handle to
%      the existing singleton*.
%
%      OSCILOSCOPIO_4('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in OSCILOSCOPIO_4.M with the given input arguments.
%
%      OSCILOSCOPIO_4('Property','Value',...) creates a new OSCILOSCOPIO_4 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Osciloscopio_4_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Osciloscopio_4_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Osciloscopio_4

% Last Modified by GUIDE v2.5 04-Mar-2019 23:31:56

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Osciloscopio_4_OpeningFcn, ...
                   'gui_OutputFcn',  @Osciloscopio_4_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Osciloscopio_4 is made visible.
function Osciloscopio_4_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Osciloscopio_4 (see VARARGIN)

% Choose default command line output for Osciloscopio_4
...
z=0;
s=0;
% UIWAIT makes Osciloscopio_4 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Osciloscopio_4_OutputFcn(hObject, eventdata, handles) 
