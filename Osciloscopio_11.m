function varargout = Osciloscopio_11(varargin)
% OSCILOSCOPIO_11 MATLAB code for Osciloscopio_11.fig
%      OSCILOSCOPIO_11, by itself, creates a new OSCILOSCOPIO_11 or raises the existing
%      singleton*.
%
%      H = OSCILOSCOPIO_11 returns the handle to a new OSCILOSCOPIO_11 or the handle to
%      the existing singleton*.
%
%      OSCILOSCOPIO_11('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in OSCILOSCOPIO_11.M with the given input arguments.
%
%      OSCILOSCOPIO_11('Property','Value',...) creates a new OSCILOSCOPIO_11 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Osciloscopio_11_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Osciloscopio_11_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Osciloscopio_11

% Last Modified by GUIDE v2.5 05-Mar-2019 10:55:32

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Osciloscopio_11_OpeningFcn, ...
                   'gui_OutputFcn',  @Osciloscopio_11_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Osciloscopio_11 is made visible.
function Osciloscopio_11_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Osciloscopio_11 (see VARARGIN)

% Choose default command line output for Osciloscopio_11
...
z=1;
s=1;
% UIWAIT makes Osciloscopio_11 wait for user response (see UIRESUME)
% uiwait(handles.Osciloscopio);
end

% --- Outputs from this function are returned to the command line.
function varargout = Osciloscopio_11_OutputFcn(hObject, eventdata, handles) 
