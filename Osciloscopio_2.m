function varargout = Osciloscopio_2(varargin)
% OSCILOSCOPIO_2 MATLAB code for Osciloscopio_2.fig
%      OSCILOSCOPIO_2, by itself, creates a new OSCILOSCOPIO_2 or raises the existing
%      singleton*.
%
%      H = OSCILOSCOPIO_2 returns the handle to a new OSCILOSCOPIO_2 or the handle to
%      the existing singleton*.
%
%      OSCILOSCOPIO_2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in OSCILOSCOPIO_2.M with the given input arguments.
%
%      OSCILOSCOPIO_2('Property','Value',...) creates a new OSCILOSCOPIO_2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Osciloscopio_2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Osciloscopio_2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Osciloscopio_2

% Last Modified by GUIDE v2.5 04-Mar-2019 21:55:23

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Osciloscopio_2_OpeningFcn, ...
                   'gui_OutputFcn',  @Osciloscopio_2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Osciloscopio_2 is made visible.
function Osciloscopio_2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Osciloscopio_2 (see VARARGIN)

% Choose default command line output for Osciloscopio_2
...
global s;
s=0;
% UIWAIT makes Osciloscopio_2 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Osciloscopio_2_OutputFcn(hObject, eventdata, handles) 
