function varargout = Osciloscopio_5(varargin)
% OSCILOSCOPIO_5 MATLAB code for Osciloscopio_5.fig
%      OSCILOSCOPIO_5, by itself, creates a new OSCILOSCOPIO_5 or raises the existing
%      singleton*.
%
%      H = OSCILOSCOPIO_5 returns the handle to a new OSCILOSCOPIO_5 or the handle to
%      the existing singleton*.
%
%      OSCILOSCOPIO_5('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in OSCILOSCOPIO_5.M with the given input arguments.
%
%      OSCILOSCOPIO_5('Property','Value',...) creates a new OSCILOSCOPIO_5 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Osciloscopio_5_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Osciloscopio_5_OpeningFcn via varargin.
%
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @Osciloscopio_5_OpeningFcn, ...
                   'gui_OutputFcn',  @Osciloscopio_5_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Osciloscopio_5 is made visible.
function Osciloscopio_5_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Osciloscopio_5 (see VARARGIN)

% Choose default command line output for Osciloscopio_5
...
z=0;
s=0;
% UIWAIT makes Osciloscopio_5 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Osciloscopio_5_OutputFcn(hObject, eventdata, handles) 
