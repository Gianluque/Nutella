function varargout = Osciloscopio_3(varargin)
% OSCILOSCOPIO_3 MATLAB code for Osciloscopio_3.fig
%      OSCILOSCOPIO_3, by itself, creates a new OSCILOSCOPIO_3 or raises the existing
%      singleton*.
%
%      H = OSCILOSCOPIO_3 returns the handle to a new OSCILOSCOPIO_3 or the handle to
%      the existing singleton*.
%
%      OSCILOSCOPIO_3('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in OSCILOSCOPIO_3.M with the given input arguments.
%
%      OSCILOSCOPIO_3('Property','Value',...) creates a new OSCILOSCOPIO_3 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Osciloscopio_3_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Osciloscopio_3_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Osciloscopio_3

% Last Modified by GUIDE v2.5 04-Mar-2019 23:17:25

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Osciloscopio_3_OpeningFcn, ...
                   'gui_OutputFcn',  @Osciloscopio_3_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Osciloscopio_3 is made visible.
function Osciloscopio_3_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Osciloscopio_3 (see VARARGIN)

% Choose default command line output for Osciloscopio_3
...
global s;
s=0;
% UIWAIT makes Osciloscopio_3 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Osciloscopio_3_OutputFcn(hObject, eventdata, handles) 
